          ...
          <Reveal>
            <div>
              <p className={styles.aboutText}>
                <span className={styles.aboutSpan}>Hi</span> there! My name is Tyler, but most just call me Toxic or Toxic Dev.
              ...
              <p className={styles.aboutText}>
                I am a Senior Software Developer specializing in Discord Bot Development. Additionally, I am a web developer specializing in front-end development,
                and I have extensive experience with all stages of the development cycle for dynamic web projects.
              </p>
              <p className={styles.aboutText}>
