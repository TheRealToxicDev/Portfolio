    ...
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {projects.map((project: Project) => (
          ...
          >
            <PinContainer title={project.source.website} href={project.source.website}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] sm:h-[40vh] h-[30vh] overflow-hidden mb-10">
                <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
                  {project.source.iframe ? (
                    ...
                    <img src={project.source.img || "/bg.png"} alt="cover" className="w-full h-full" />
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {project.iconLists.map((Icon: IconType, index: number) => (
                    <div
                      key={index}
                ...
                <div className="flex space-x-4">
                  <button onClick={() => openModal(project)} className="text-purple inline-flex items-center">
                    <FaEye size={24} />
                    <span className="ml-1">
                      More Info
                    </span>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal}>
          ...
          <div className="flex space-x-4 mt-4">
            {selectedProject.source.website && (
              <a href={selectedProject.source.website} target="_blank" rel="noopener noreferrer">
                <FaLocationArrow className="text-purple" size={24} />
              </a>
            )}
            {selectedProject.source.github && (
              <a href={selectedProject.source.github} target="_blank" rel="noopener noreferrer">
